...
private let kReadArticles = "jimmy.readArticles"
private let kReadCount    = "jimmy.readCount"
...
struct NewsRow: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            // Action row: Share + Save to Jimmy + Read indicator
            HStack(spacing: 14) {
                ...
                Button {
                    ...
                    HStack(spacing: 4) {
                        ...
                        Text(savedToast ? "Saved" : "Save to Jimmy")
                            .font(.system(size: 12))
                    }
