...
class ReadingProgressStore {
    ...
    private let keyPrefix = "jimmy_reading_progress_"
...
class VoiceRecorder: NSObject, ObservableObject {
    ...
    func start() throws {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("jimmy_voice_\(Int(Date().timeIntervalSince1970)).m4a")
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            if permissionDenied {
                ...
                Text(recorder.isRecording ? "Speak freely — what did you learn, think about, or want to remember?" : "Tap the mic and speak. Jimmy will transcribe and save it to your knowledge base.")
                    .font(.system(size: 13))
                    .foregroundStyle(.secondary)
                    .lineLimit(3)
