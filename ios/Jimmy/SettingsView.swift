...
struct SettingsView: View {
            ...
            Form {
                ...
                Section("Countdowns") {
                    HStack {
                        ...
                        Spacer()
                        let datadogDate = Calendar.current.date(from: DateComponents(year: 2026, month: 7, day: 6))!
                ...
                Section("About") {
                    ...
                    Link(destination: URL(string: "mailto:feedback@jimmy.app")!) {
                        HStack {
    ...
    private func clearCaches() async {
        ...
        let cacheDir = cacheBase.appendingPathComponent("jimmy")
        do {
