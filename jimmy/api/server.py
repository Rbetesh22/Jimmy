...
def news(refresh: bool = False):
    ...
    RSS_FEEDS = [
        ...
        {"url": "https://api.axios.com/feed/", "category": "World", "label": "Axios"},
        # Israel / Middle East
        ...
        {"url": "https://www.calcalist.co.il/GeneralRSS/0,16335,L-8,00.xml", "category": "Israel", "label": "Calcalist"},
        {"url": "https://www.globes.co.il/webservice/rss/rssfeeder.asmx/FeederNode?iID=585", "category": "Israel", "label": "Globes"},
        # Torah / Jewish Life
        ...
        {"url": "https://www.theverge.com/rss/ai-artificial-intelligence/index.xml", "category": "AI", "label": "Verge AI"},
        {"url": "https://www.wired.com/feed/tag/ai/latest/rss", "category": "AI", "label": "Wired AI"},
        {"url": "https://www.technologyreview.com/feed/", "category": "AI", "label": "MIT Tech Review"},
        # Finance / Business
    ...
    TWITTER_TARGETS = [
        ...
        ("user", "elikiobel",      "Israel",   "Eli Klein"),
        ("user", "nikifriedman",   "Israel",   "Niki Friedman"),
        ("user", "BBCBreaking",    "World",    "BBC Breaking"),
        ("user", "Reuters",        "World",    "Reuters Live"),
        ("user", "WSJ",            "World",    "WSJ"),
        ("user", "Morning_Brew",   "World",    "Morning Brew"),
        ("user", "AnthropicAI",    "AI",       "Anthropic"),
        ("user", "sama",           "AI",       "Sam Altman"),
        ("user", "OpenAI",         "AI",       "OpenAI"),
        ("user", "GoogleAI",       "AI",       "Google AI"),
        ("user", "demaboris",      "AI",       "Demis Hassabis"),
        ("user", "DatadogHQ",      "Tech",     "Datadog"),
